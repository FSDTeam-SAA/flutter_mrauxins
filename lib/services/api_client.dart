...
class Urls {
  ...
  static const String swaggerDoc =
      'https://telegram-clone-4gd7.onrender.com/api-docs'; //Local Testing

  // static const String baseURL = 'https://2531-116-72-2-183.ngrok-free.app'; //Local Testing
  // static const String mediaUrl = 'https://2531-116-72-2-183.ngrok-free.app/media/'; // Local Testing

  static const String baseURL = 'http://18.130.137.253'; //Live Server
  static const String mediaUrl =
      'https://telegrameclone.s3.eu-west-2.amazonaws.com/'; // Live Server
}
